...
<html lang="en" class="scroll-smooth">
  ...
  <body>
    ...
    <!-- Header End -->
    <!-- About Section Start -->
    <section id="services" class="pt-36 pb-32 dark:bg-dark">
      <div class="container">
        <div class="w-full px-4">
          <div class="mx-auto mb-16 text-center">
            <h4 class="mb-3 text-lg font-bold uppercase text-primary">about me</h4>
            <p class="text-md font-medium text-white md:text-lg">Hello everyone, My name is Muhammad Lutfi Pratama Putra. I'm currently studying as a 5th semester information engineering student at Pembangunan Jaya University. During my study up to semester 5, I have studied the programming languages ​​C, Python, Java, HTML, CSS, Bootstrap, PHP, and JavaScript.</p>
          </div>
        </div>
          <div class="mx-auto mb-16 text-center">
            <h4 class="mb-3 text-lg font-bold uppercase text-primary">this is my social media</h4>
              <div class="flex items-center" style="justify-content: center">
                <!-- Facebook -->
                <a
                  href="https://web.facebook.com/luthfiputrama/"
                  target="_blank"
                ...
                <!-- Instagram -->
                <a
                  href="https://www.instagram.com/luthfiputrama/"
                  target="_blank"
                  class="mr-3 flex h-9 w-9 items-center justify-center rounded-full border border-slate-300 text-slate-300 hover:border-primary hover:bg-primary hover:text-white"
                >
                  <svg role="img" width="20" class="fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <!-- Github -->
                <a
                  href="https://github.com/Piluthfi"
                  target="_blank"
                  class="mr-3 flex h-9 w-9 items-center justify-center rounded-full border border-slate-300 text-slate-300 hover:border-primary hover:bg-primary hover:text-white"
                >
                  <svg role="img" width="20" class="fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
